 ...
 * para registro de callback. Em C e C++ usam se ponteiros para função, já em Java usam uma
...
namespace Estudando.Delegates
{
    class Program
    {
        ...
        */
         ...
         * Como dito antes, o C# cria uma classe implicitamente para o seu delegate
         * por isso callback é um tipo referência AvisoConsulta, e no contrutor é passado
