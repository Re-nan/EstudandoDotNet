...
namespace EstudandoStringConstrutores
{
    class Program
    {
        static void Main(string[] args)
        {
             ...
             * 1 - Posso criar uma string a partir de um array de caracteres
             */
            ...
            /* 3 - Posso criar uma string a partir de um caracterer que se repetira na qtd de vezes q eu quiser*/
